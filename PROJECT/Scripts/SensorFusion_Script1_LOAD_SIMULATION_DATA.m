...
simData = load('..\Simulation_Data_Scenarios\SCENARIO_1\SCENE_1_RAW.mat');
...
save('..\Simulation_Data_Scenarios\SCENE_1.mat', 'SimulationScenario');
clearvars; %clear all;
load('..\Simulation_Data_Scenarios\SCENE_1.mat');
% ==============================================================================================================================================================
% Simulation Time
...
EGO_IgnitionStatus = true(length(EGO_TimeStamp), 1);
%EGO_IgnitionStatus(1,1) = false;
% ==============================================================================================================================================================
